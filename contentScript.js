...
const headerDOM = `
  <div id="top-bar" aria-label="itp header">
    ...
    <button id="explore-button" onclick="exploreDropDown()" aria-label="explore button">
      EXPLORE
    </button>
  </div>
  <menu id="bottom-bar" aria-label="navigate menu">
...
function exploreDropDown() {
  ...
  const isExpanding = exploreButton.innerHTML === `EXIT` ? false : true;
  exploreButton.innerHTML = isExpanding ? `EXIT` : `EXPLORE`;
